...
const VirtualSyllabusScreen = ({navigation}) => {
    ...
    ApiMethod.quizBundleNew(
      pass => {
        ...
        if (pass.status == 200) {
          ...
          var w1 = pass.data.filter(m => m.week == 1);
    ...
    if (index == 0) {
      if (item.week.id == 1) {
        ...
        if (i > -1) {
          ...
          if (prevQuizes && prevQuizes.length > 0) {
                              ...
                              <View
                                ...
                                <TouchableOpacity
                                  onPress={() => {
                                    ...
                                    console.log(item?.google_doc_url);
                        ...
                        {!item.is_locked && (
                          ...
                          <View
                            ...
                            <View
                              ...
                              {item.abbreviations && item.total_hours && (
                                <View
                                  style={{
                                    flexDirection: 'row',
                                    // paddingHorizontal: 2 * width,
                            ...
                            {(item.instruction_and_tools?.chapter_video_quiz ||
                              item.instruction_and_tools?.chapter_test ||
                              item.instruction_and_tools?.vocabulary ||
                              item.instruction_and_tools?.chapter_workbook ||
                              item.instruction_and_tools?.abbreviations ||
                              item.instruction_and_tools?.skills ||
                              item.instruction_and_tools
                                ?.instructor_pre_recorded_zoom ||
                ...
                allChapterList[modalVisibleIndex].google_doc_url.map(
                  (item1, index) => (
                    <TouchableOpacity
                      key={index}
                      onPress={() => {
                        console.log(allChapterList[modalVisibleIndex]);
...
export default VirtualSyllabusScreen;
