import { SafeAreaView, StyleSheet, Text, View, Image, FlatList, TouchableOpacity, Platform, Modal, Dimensions, ScrollView, RefreshControl } from 'react-native';
...
const AsignmentUploadTablet = ({ navigation, route }) => {
...
export default AsignmentUploadTablet;
