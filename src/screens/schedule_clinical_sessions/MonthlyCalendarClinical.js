...
const MonthlyCalendarClinical = props => {
  ...
  const getCalendarData = () => {
    ...
    ApiMethod.getClinicalCalendarData(
      pass => {
  ...
  const onDatePress = data => {
    ...
    if (data.is_scheduled) {
      ToastUtility.showToast('Clinical session already scheduled for selected date');
    } else {
  ...
  const schedule1to1 = () => {
    ...
    // });
    // console.log('=-=-=--', t2);
    ApiMethod.scheduleClinical1to1(
      {
        title: title,
        ...
        <View
          ...
          <ScrollView
            ...
            {/* {user?.type == 'virtual' && quizSelectedList.length > 0 && (
              <ScrollView style={{maxHeight: 20 * height}}>
...
export default MonthlyCalendarClinical;
